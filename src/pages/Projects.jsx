    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-6 bg-sky-50 rounded-lg shadow-md my-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <Link to="/addProject">
                    <button className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-sky-500 text-white font-medium rounded-md hover:bg-sky-600 transition-colors">
                        Add Project
                    </button>
                </Link>
                                    ...
                                    <tr key={pro._id} className="hover:bg-sky-50">
                                        ...
                                        <td className="px-2 sm:px-4 py-2 sm:py-3 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                <button className="text-red-600 hover:text-red-800 transition-colors p-1 rounded-full hover:bg-red-50">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                    </svg>
                                                </button>
                                                <button className="text-sky-600 hover:text-sky-800 transition-colors p-1 rounded-full hover:bg-sky-50">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
